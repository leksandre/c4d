      ...
      window.addEventListener("DOMContentLoaded", (event) => {
        ...
        if (typeof chatIcons1 !== "undefined") {
          ...
          newdiv.onclick = function () {
            let elementWithIcons = parent.document.getElementById('18iconsChat');
          ...
          let elementWithIcontelegramm = parent.document.getElementById('chat_telegram');
