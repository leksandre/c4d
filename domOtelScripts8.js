...
newdiv.innerHTML='<div id="18iconsChat" style="display: none; position: absolute;bottom: 60px;right: 0px;width: 45px;height: 45px;" >'
+'<svg id="chat_telegram" style="cursor:pointer; " xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 240.1 240.1"  height="45px" width="45px" >'
...
+'</svg>'
+'</div>'
+'<svg style="cursor:pointer; " fill="#fff" height="25px" width="25px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" '
